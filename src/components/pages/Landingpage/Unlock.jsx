    ...
    return (
        <div className='relative max-w-[1920px] mx-auto px-4 md:px-10 mt-16'>
            <div ref={propertyImageRef} className='w-full h-[660px] overflow-hidden '>
                <img
                    ref={propertyImgRef}
                    src={data?.heroImage ? urlFor(data.heroImage).width(1200).height(660).url() : "/assets/unlock.jpg"}
                    alt="Hero Background"
                ...
                <div className='flex flex-col justify-center items-start gap-6 pl-0 sm:pl-16 md:pl-16 lg:pl-20'>
                    <div className='leading-none text-center sm:text-left gap-0 px-10 sm:px-0'>
                        <TextAnimation
                            ...
                            delay={0.2}
                        >
                            {data?.title || 'Rehouse – flips som faktisk løfter verdien'}
                        ...
                        <TextAnimation
                            ...
                            delay={0.2}
                        >
                            {data?.subtitle1 || 'Jeg heter Salman. Jeg kjøper, totalrenoverer og optimaliserer leiligheter i Oslo –'}
                        </TextAnimation>
                        <TextAnimation
                            ...
                            delay={0.2}
                        >
                            {data?.subtitle2 || 'smart planløsning, solid utførelse og dokumentert samsvar.'}
                        </TextAnimation>
                    </div>
                    <Link href={data?.ctaLink || '/portfolio'} className='flex justify-center items-center w-full md:justify-start md:items-start'>
                        <AnimatedButton
